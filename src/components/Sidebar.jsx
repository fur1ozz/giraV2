    ...
    return(
      <>
          ...
          dark:bg-[#1d2125] dark:text-[#b6c2cf] dark:border-[#282f35]">
              ...
              <Link to="/dashboard" className="flex h-[40px] hover:bg-[#06b6d44a] rounded-sm px-2 py-[5px] mb-2 items-center justify-between dark:hover:bg-[#8b5cf64a]">
              ...
              <Link to="/project" className="flex h-[40px] hover:bg-[#06b6d44a] rounded-sm px-2 py-[5px] mb-2 items-center justify-between dark:hover:bg-[#8b5cf64a]">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
              ...
              <Link to="/calendar" className="flex h-[40px] hover:bg-[#06b6d44a] rounded-sm px-2 py-[5px] mb-2 items-center justify-between dark:hover:bg-[#8b5cf64a]">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
              ...
              <Link to="/new" className="flex h-[40px] hover:bg-[#06b6d44a] rounded-sm px-2 py-[5px] mb-2 items-center justify-between dark:hover:bg-[#8b5cf64a]">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
