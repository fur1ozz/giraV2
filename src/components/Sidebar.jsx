    ...
    return(
      <>
          ...
          dark:bg-[#1d2125] dark:text-[#b6c2cf] dark:border-[#282f35]">
              ...
              <Link to="/project" className="flex h-[40px] hover:bg-neutral-300 rounded-sm px-2 py-[5px] mb-2 items-center justify-between">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
              ...
              <Link to="/calendar" className="flex h-[40px] hover:bg-neutral-300 rounded-sm px-2 py-[5px] mb-2 items-center justify-between">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
