            ...
            <div className='w-100 min-h-screen ms-[250px] max-sm:ms-[80px] max-[500px]:ms-0 dark:bg-[#1d2125] dark:text-white flex flex-col items-center overflow-auto'>
                <div className="border-b border-[#e5e7eb] dark:border-[#282f35] w-[85%] py-6 mb-6 flex">
                    <div className='flex flex-col mx-6 w-full justify-center text-center'>
                        <h1 className="text-6xl mb-2 font-bold text-neutral-700 dark:text-[#b6c2cf]">Welcome to GiraV2!</h1>
                        <p className="text-3xl mb-2 font-normal text-neutral-700 dark:text-[#b6c2cf]">Your Ultimate Project Management Companion!</p>
                    </div>
                </div>
                <div className='flex flex-wrap w-full h-full justify-center '>
                    <div className='flex w-[90%] text-center justify-center'>
                    <p className='text-2xl align-center font-normal text-neutral-700 dark:text-[#b6c2cf]'>Created, Maintained and Run by 3 passionate coders:</p>
                    </div>
