        ...
        <header className="bg-neutral-100 p-4 top-0 w-full sticky z-20 dark:bg-[#1d2125] border-b-2 dark:border-[#282f35]">
            <div className="container mx-auto flex justify-between items-center">
                ...
                {isMobileMenuOpen && (
                    <div className="md:hidden fixed top-16 left-0 w-full h-full bg-neutral-100 dark:bg-[#1d2125] ">
                        <nav className="flex flex-col items-center pt-5">
                            ...
                            <Link to="/services" className="text-cyan-500 hover:text-cyan-600 dark:text-violet-500 dark:hover:text-violet-800 py-2 flex">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                            ...
                            <Link to="/Contact" className="text-cyan-500 hover:text-cyan-600 dark:text-violet-500 dark:hover:text-violet-800 py-2 flex">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                ...
                <nav className="hidden md:flex space-x-4">
                    ...
                    <Link to="/Contact" className="text-cyan-500 hover:text-cyan-600 dark:text-violet-500 dark:hover:text-violet-800">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                            <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z" />
                        </svg>
                    </Link>
